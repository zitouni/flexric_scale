...
bool eq_mac_ind_msg(mac_ind_msg_t* m0, mac_ind_msg_t* m1)
{
  ...
  for (uint32_t i = 0; i < m0->len_ue_stats; ++i) {
    ...
    if (ue0->dl_aggr_tbs != ue1->dl_aggr_tbs || ue0->ul_aggr_tbs != ue1->ul_aggr_tbs
        || ue0->dl_aggr_bytes_sdus != ue1->dl_aggr_bytes_sdus || ue0->ul_aggr_bytes_sdus != ue1->ul_aggr_bytes_sdus
        || ue0->dl_curr_tbs != ue1->dl_curr_tbs || ue0->ul_curr_tbs != ue1->ul_curr_tbs || ue0->dl_sched_rb != ue1->dl_sched_rb
        || ue0->ul_sched_rb != ue1->ul_sched_rb || ue0->rnti != ue1->rnti || ue0->dl_aggr_prb != ue1->dl_aggr_prb
        || ue0->ul_aggr_prb != ue1->ul_aggr_prb || ue0->dl_aggr_sdus != ue1->dl_aggr_sdus || ue0->ul_aggr_sdus != ue1->ul_aggr_sdus
        || ue0->dl_aggr_retx_prb != ue1->dl_aggr_retx_prb || ue0->ul_aggr_retx_prb != ue1->ul_aggr_retx_prb
        || ue0->wb_cqi != ue1->wb_cqi || ue0->dl_mcs1 != ue1->dl_mcs1 || ue0->ul_mcs1 != ue1->ul_mcs1
        || ue0->dl_mcs2 != ue1->dl_mcs2 || ue0->ul_mcs2 != ue1->ul_mcs2 || ue0->phr != ue1->phr || ue0->bsr != ue1->bsr
        || ue0->dl_bler != ue1->dl_bler || ue0->ul_bler != ue1->ul_bler || ue0->dl_num_harq != ue1->dl_num_harq
        || ue0->dl_harq[0] != ue1->dl_harq[0] || ue0->dl_harq[1] != ue1->dl_harq[1] || ue0->dl_harq[2] != ue1->dl_harq[2]
        || ue0->dl_harq[3] != ue1->dl_harq[3] || ue0->dl_harq[4] != ue1->dl_harq[4] || ue0->ul_num_harq != ue1->ul_num_harq
        || ue0->ul_harq[0] != ue1->ul_harq[0] || ue0->ul_harq[1] != ue1->ul_harq[1] || ue0->ul_harq[2] != ue1->ul_harq[2]
        || ue0->ul_harq[3] != ue1->ul_harq[3] || ue0->ul_harq[4] != ue1->ul_harq[4] || ue0->frame != ue1->frame
        || ue0->slot != ue1->slot || eq_float(ue0->pusch_snr, ue1->pusch_snr, 0.0000001) == false
