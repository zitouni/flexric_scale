...
static sm_subs_data_t on_subscription_tc_sm_ric(sm_ric_t const* sm_ric, void* cmd)
{
  assert(sm_ric != NULL);
  assert(cmd != NULL);
...
static sm_ag_if_rd_ind_t on_indication_tc_sm_ric(sm_ric_t const* sm_ric, sm_ind_data_t const* data)
{
  assert(sm_ric != NULL);
  assert(data != NULL);
  sm_tc_ric_t* sm = (sm_tc_ric_t*)sm_ric;
...
static sm_ctrl_req_data_t ric_on_control_req_tc_sm_ric(sm_ric_t const* sm_ric, void* ctrl)
{
  assert(sm_ric != NULL);
  assert(ctrl != NULL);
...
static sm_ag_if_ans_ctrl_t ric_on_control_out_tc_sm_ric(sm_ric_t const* sm_ric, const sm_ctrl_out_data_t* out)
{
  assert(sm_ric != NULL);
  assert(out != NULL);
...
static sm_ag_if_rd_e2setup_t ric_on_e2_setup_tc_sm_ric(sm_ric_t const* sm_ric, sm_e2_setup_data_t const* setup)
{
  assert(sm_ric != NULL);
  assert(setup != NULL);
...
static sm_ag_if_rd_rsu_t on_ric_service_update_tc_sm_ric(sm_ric_t const* sm_ric, const sm_ric_service_update_data_t* data)
{
  assert(sm_ric != NULL);
  assert(data != NULL);
...
static void free_subs_data_tc_sm_ric(void* msg)
{
  assert(msg != NULL);
  assert(0 != 0 && "Not implemented");
}

static void free_ind_data_tc_sm_ric(void* msg)
{
  assert(msg != NULL);
...
static void free_ctrl_req_data_tc_sm_ric(void* msg)
{
  assert(msg != NULL);
  assert(0 != 0 && "Not implemented");
}

static void free_ctrl_out_data_tc_sm_ric(void* msg)
{
  assert(msg != NULL);
  assert(0 != 0 && "Not implemented");
}

static void free_e2_setup_tc_sm_ric(void* msg)
{
  assert(msg != NULL);
  assert(0 != 0 && "Not implemented");
}

static void free_ric_service_update_tc_sm_ric(void* msg)
{
  assert(msg != NULL);
  assert(0 != 0 && "Not implemented");
}
