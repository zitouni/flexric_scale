...
static const ber_tlv_tag_t asn_DEF_RICsubscription_List_withCause_tags_1_e2ap_v2_03[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
...
asn_TYPE_descriptor_t asn_DEF_RICsubscription_List_withCause = {
	...
	"RICsubscription-List-withCause",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_RICsubscription_List_withCause_tags_1_e2ap_v2_03,
	sizeof(asn_DEF_RICsubscription_List_withCause_tags_1_e2ap_v2_03)
		/sizeof(asn_DEF_RICsubscription_List_withCause_tags_1_e2ap_v2_03[0]), /* 1 */
	asn_DEF_RICsubscription_List_withCause_tags_1_e2ap_v2_03,	/* Same as above */
	sizeof(asn_DEF_RICsubscription_List_withCause_tags_1_e2ap_v2_03)
		/sizeof(asn_DEF_RICsubscription_List_withCause_tags_1_e2ap_v2_03[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
